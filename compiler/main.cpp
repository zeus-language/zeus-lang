...
static void printHelp(const std::string &program) {
    ...
    std::cout << "  -I<path>\t\tAdds an include directory\n";
    std::cout << "  -L<path>\t\tAdds a library directory\n";
    std::cout << "  --fuse-ld=<ld>\t\tUses the specified linker instead of the default system linker\n";
